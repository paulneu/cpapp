...
function getPagesAndConfigs(manifest, schemas, logger) {
    ...
    for (const id in routing.targets) {
        ...
        if (target['name']) {
            pageType =
                target['name'] === v4_1.FE_TEMPLATE_V4_CUSTOM_PAGE
            ...
            __1.log(logger, {
                ...
                location: {
                    ...
                    range: [`${v4_1.ManifestSection.ui5}/routing/targets/${id}`]
                }
            });
        ...
        if ('viewId' in target) {
            ...
            const customPageName = ((_b = (_a = target.options) === null || _a === void 0 ? void 0 : _a.settings) === null || _b === void 0 ? void 0 : _b.viewName) || target['viewName'];
        ...
        if (jsonSchema) {
            if (pageType === common_2.PageTypeV4.ListReport) {
            ...
            else if (page.pageType === common_2.PageTypeV4.AnalyticalListPage) {
                const importParameters = {
                    manifest,
                    jsonSchema: schemas[jsonSchema],
                    logger
            ...
            else if (page.pageType === common_2.PageTypeV4.ObjectPage) {
                const importParameters = {
                    manifest,
                    jsonSchema: schemas[jsonSchema],
                    routingId: id,
...
class V4AppProvider extends appProvider_1.AppProvider {
    constructor(manifest, schemas, logger) {
        ...
        super(manifest, schemas, getHome(manifest[v4_1.ManifestSection.ui5].routing), getPagesAndConfigs(manifest, schemas, logger), common_2.FioriElementsVersion.v4, Object.assign(Object.assign({}, getSettings(manifest[v4_1.ManifestSection.ui5].routing)), appSettings), logger);
